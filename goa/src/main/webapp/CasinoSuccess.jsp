...
<div>
			...
			<div class="container-fluid">
				...
				<form class="d-flex">
					<input class="form-control me-3" type="search" placeholder="Search"
						...
						href="index.jsp"/>Home</a> <a href="casino.jsp"/>Casino</a>
	...
	<h2>Name of Casino : ${name}</h2>
	<h3>Name of Cruise : ${cruise}</h3>
	<h4>Casino Entry Fee :${fee}</h4>
	<h4>Food of Casino : ${food}</h4>
	<h4>Casino Alcohal : ${alcohal} </h4>
<div>
</body>
</html>